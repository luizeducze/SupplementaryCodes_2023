...
Nx = 100; % largura do dominio
Ny = 200; % altura do dominio
% Tempo de relaxacao
tau_v = 1;
tau_b = 0.75;
%tau_b = 1;
...
%rho_1 = 0.02172865606779925;
rho_1 = 0.009296630941403625;
%rho_2 = 0.30717839640781797;
rho_2 = 0.3581171329791306;
kappa = 0.5;
...
%save('Coalescencia_Free_Energy','Est_1','Est_2','a','b','R','kappa')
