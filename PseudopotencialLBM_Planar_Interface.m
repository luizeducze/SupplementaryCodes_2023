...
G = -1;
kappa_1 = 0.9190714865493569; % Equivalent to kappa_P in the paper
kappa_2 = 0; % Equivalent to kappa_Li in the paper
epsilon = 1.9373335029111907;
%epsilon = 1.9168;
...
for i = 1:Nx
    for j = 1:Ny
        ...
        rho(i,j) = (rho_1+rho_2)/2 + (rho_2-rho_1)/2*tanh( (radius-pos)/sqrt(2)/(epsilon+1) );
    end
end
%*************************************************************************
